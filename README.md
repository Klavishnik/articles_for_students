...
[BASH. Основные команды](/BASH.pdf)

[GDB. Отладчик, практическое руководство](/GDB.pdf)

[GIT. Система контроля версий](/GIT.pdf)

[Безопасное программирование. Часть 1. Особенности компиляции, UBSAN, переполнения, scanf](/SDL_1.md)
